...
public class Caso1 {
    public static void  main(String [] args ) {
        ...
        WebElement continuar1 = driver.findElement(By.xpath("//*[@id=\"center_column\"]/p[2]/a[1]"));
        continuar1.click();

        js.executeScript("window.scrollBy(0,500)");
        WebElement continuar2 = driver.findElement(By.name("processAddress"));
        continuar2.click();

        js.executeScript("window.scrollBy(0,500)");

        WebElement terminosycondiciones = driver.findElement(By.name("cgv"));
        ...
        WebElement pago = driver.findElement(By.xpath("//*[@id=\"HOOK_PAYMENT\"]/div[1]/div"));
        pago.click();
